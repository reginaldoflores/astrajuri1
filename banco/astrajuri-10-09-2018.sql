...
--
-- Host: 127.0.0.1
-- Generation Time: 10-Set-2018 às 21:27
-- Versão do servidor: 10.1.32-MariaDB
-- PHP Version: 5.6.36

CREATE DATABASE astrajuri
...
(6, '00653715320128190205', 'Reginaldo Moro', 'Vinicius Lima e Cruz', 'Walter Lemos', 1, 6, NULL, 2, 1, 1, NULL),
...
(13, '70770909809887987907', 'juiz do 2', 'advogado do 2', 'testador 2', 3, 3, NULL, 7, 3, 1, 2),
(14, '30292722994048671617', 'Juiz do Caso', 'Advogado do Réu', 'Réu ', 2, 3, NULL, 2, 1, 1, NULL);
...
(4, 'levi', '202cb962ac59075b964b07152d234b70', 1, 16);
...
--
ALTER TABLE `advogado`
  MODIFY `idAdvogado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `processo`
  MODIFY `idProcesso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
