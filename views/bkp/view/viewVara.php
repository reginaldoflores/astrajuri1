<div class="right_col" role="main">
	...
	<div class="col-md-12">
            <div class="x_panel">
                ...
                <div class="x_title">
                    <h2> Dados de Varas</h2>
                    <div class="clearfix"></div>
                </div>
                    
                <div class="x_content">
                    
                    <p><strong>Vara: </strong> <?= utf8_encode($vara['Nome']); ?></p>
	...
	<div class="col-md-12">
            <a href="<?= HOME; ?>/vara" class="btn btn-primary">Fechar</a>
            <a href="<?= HOME; ?>/vara/edit/<?= $vara['idVara']; ?>" class="btn btn-default">Editar</a>
            <a href="<?= HOME; ?>/vara/del/<?= $vara['idVara']; ?>" vara/class="btn btn-default" data-toggle="modal" data-target="#delete-modal">Excluir</a>
	</div>
    </div>
</div>
