    ...
    <div id="main" class="container-fluid">
        ...
        <form method="post" class="form-horizontal form-label-left" novalidate>
			...
			<input name="data[search]" class="form-control" id="search" type="text" placeholder="Pesquisar Vara">
                ...
                <div class="col-sm-3">
                    <a href="#" class="btn btn-primary btn-medium pull-right h2">Nova Vara</a>
		</div>
            </div> <!-- /#top -->
                        ...
                        <div class="x_content">
                            ...
                            <form method="post" class="form-horizontal form-label-left" novalidate>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tel">Selecionar Comarca<span class="required">*</span>
                                    </label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                      <input type="text" list="Comarcas" id="tel" name="phone" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="vara">Cadastrar a Vara: <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="data_nasc" name="vara" required="required" data-validate-length-range="8" class="form-control col-md-7 col-xs-12">
                                    </div>   
                                </div>
